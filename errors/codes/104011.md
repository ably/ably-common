...
title: Session history fetch failed
summary: Loading an AI Transport session's channel history failed after retries, so the messages needed to rebuild session state could not be retrieved.
---
