---
code: 40033
identifier: operation_cancelled
title: Operation cancelled
summary: An operation was stopped before completing, so its result was discarded. This usually happens when the connection or request that triggered the operation ends first.
---
...
The error is reported with code 40033 and HTTP status 400. The message is `operation cancelled`; the spelling `operation canceled` appears on some paths.
